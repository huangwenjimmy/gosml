...
func ConvertToInt(i interface{}) int64 {
	...
	switch {
	case kind == reflect.String:
		result, _ = strconv.ParseInt(rv.String(), 10, 64)
	case kind >= reflect.Int && kind <= reflect.Int64:
		result = rv.Int()
	case kind >= reflect.Uint && kind <= reflect.Uint64:
		result = int64(rv.Uint())
	case kind >= reflect.Float32 && kind <= reflect.Float64:
		result = int64(rv.Float())
	case kind == reflect.Bool:
		if rv.Bool() {
			result = int64(1)
		} else {
...
func ConvertToFloat(i interface{}) float64 {
	...
	switch {
	case kind == reflect.String:
		result, _ = strconv.ParseFloat(rv.String(), 64)
	case kind >= reflect.Int && kind <= reflect.Int64:
		result = float64(rv.Int())
	case kind >= reflect.Uint && kind <= reflect.Uint64:
		result = float64(rv.Uint())
	case kind >= reflect.Float32 && kind <= reflect.Float64:
		result = float64(rv.Float())
	case kind == reflect.Bool:
		if rv.Bool() {
			result = float64(1)
		} else {
